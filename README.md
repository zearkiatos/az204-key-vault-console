# Description
This is a C# 🟪 console application to integrate the console with key vault 🔐🔑to management secrets. This is in order to study and practice for az204 certification exam 🤓📚🎓
